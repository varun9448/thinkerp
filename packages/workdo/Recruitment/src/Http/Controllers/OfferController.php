...
class OfferController extends Controller
{
    ...
    {
        // Authenticated users need the download permission; guests can access via the encrypted public link
        if (Auth::check() && !Auth::user()->can('download-offer-letters')) {
