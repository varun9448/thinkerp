...
class ProjectApiController extends Controller
{
            ...
            if (Auth::user()->can('manage-project')) {
                ...
                $items->getCollection()->transform(function ($project) {
                    ...
                    return [
                        ...
                        'bonus_budget'   => $project->bonus_budget,
    ...
    private function createProject(Request $request)
    {
        if (Auth::user()->can('create-project')) {
            $validator = Validator::make($request->all(), [
                ...
                'bonus_budget' => 'nullable|numeric|min:0',
    ...
    private function updateProject(Request $request)
    {
        if (Auth::user()->can('edit-project')) {
            ...
            if ($project->status === 'Finished' && !$project->finished_at) {
                $project->finished_at = now();
            }
            if ($project->status !== 'Finished' && !$project->bonus_paid_at) {
        ...
        try {
            if (Auth::user()->can('view-project')) {
                ...
                $projectDetails = [
                    ...
                    'bonus_budget' => number_format($project->bonus_budget),
