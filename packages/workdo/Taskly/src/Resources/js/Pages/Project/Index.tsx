                                        ...
                                        <Card key={project.id} className="p-0 hover:shadow-lg transition-all duration-200 relative overflow-hidden flex flex-col h-full min-w-0">
                                            ...
                                            <div className="p-4 flex-1 min-h-0">
                                                <div className="grid grid-cols-2 gap-4 mb-4">
                                                    ...
                                                    <div className="text-xs min-w-0">
                                                        <p className="text-muted-foreground mb-1 text-xs uppercase tracking-wide">{t('Bonus')}</p>
                                                        <p className="font-medium text-xs">{project.bonus_budget ? formatCurrency(project.bonus_budget) : '-'}</p>
                                                    </div>
                                                </div>
