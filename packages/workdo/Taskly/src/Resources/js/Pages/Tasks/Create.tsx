                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) => setData('bonus_stars', parseFloat(e.target.value) || 0)}
                        />
                        <InputError message={errors.bonus_stars} />
                    </div>
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) => setData('bonus_lead_days', e.target.value === '' ? null : parseInt(e.target.value, 10))}
                        />
                        <InputError message={errors.bonus_lead_days} />
                    </div>
                </div>
