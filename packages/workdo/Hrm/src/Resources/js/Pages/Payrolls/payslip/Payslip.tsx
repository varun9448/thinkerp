...
interface PayrollEntry {
    ...
    project_bonus_breakdown: Record<string, { amount: number; earned_stars: number; total_stars: number; bonus_budget: number }>;
}
                    ...
                    <div className="p-1 pl-1">
                        ...
                        <div className="grid grid-cols-2 gap-0 border border-black mt-1">
                            ...
                            <div className="border-r border-black">
                                ...
                                <div className="p-3 space-y-1">
                                    ...
                                    {payrollEntry.project_bonus > 0 && (
                                        <>
                                            <div className="text-xs font-semibold text-gray-600 pt-1">{t('Project Bonus')}:</div>
                                            {Object.entries(payrollEntry.project_bonus_breakdown || {}).map(([name, bonus]) => (
                                                <div key={name} className="flex justify-between pl-2">
                                                    <span className="text-sm">{name} ({Number(bonus.earned_stars || 0)} / {Number(bonus.total_stars || 0)} {t('stars')})</span>
                                                    <span className="text-sm">{formatCurrency(Number(bonus.amount || 0))}</span>
                                                </div>
                                            ))}
                                        </>
                                    )}
                        ...
                        <div className="mt-2 space-y-2">
                            <div className="px-3 py-3 flex justify-between items-center">
                                <span><span className="font-bold">{t('Gross Pay')}</span> (Basic + Allowances + Overtimes + Project Bonus - Leave Deductions)</span>
