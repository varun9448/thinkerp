                        ...
                        <CardContent className="space-y-3">
                            ...
                            {payrollEntry.project_bonus > 0 && (
                                <>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between font-medium">
                                            <span>{t('Project Bonus')}</span>
                                            <span>{formatCurrency(payrollEntry.project_bonus)}</span>
                                        </div>
                                        {Object.entries(payrollEntry.project_bonus_breakdown || {}).map(([name, bonus]) => (
                                            <div key={name} className="flex justify-between text-sm text-gray-600 ml-4">
                                                <span>{name} ({Number(bonus.earned_stars || 0)} / {Number(bonus.total_stars || 0)} {t('stars')})</span>
                                                <span>{formatCurrency(Number(bonus.amount || 0))}</span>
                                            </div>
                                        ))}
                                    </div>
                                </>
                                ...
                                <div className="flex justify-between text-lg">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            (Basic + Allowances + Overtimes + Project Bonus) - Leave Deductions
                                        </p>
                                    </div>
