...
const METHOD_LABELS: Record<string, string> = {
    ...
    cash: 'Cash', cheque: 'Cheque', card: 'Card', bank_transfer: 'Bank Transfer', other: 'Other',
};
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <span className={`px-2 py-1 rounded text-sm font-medium ${METHOD_COLORS[payment.payment_method] ?? 'bg-gray-100 text-gray-600'}`}>
                            ...
                            {payment.reference_number && (
                                <div>
                                    <span className="font-semibold">
                                        {payment.payment_method === 'upi' ? t('UTR / UPI Transaction ID') : t('Reference Number')}
                                    </span>
                                    <p className="mt-1 text-gray-500 font-mono">{payment.reference_number}</p>
                                </div>
                            )}
                            <div>
