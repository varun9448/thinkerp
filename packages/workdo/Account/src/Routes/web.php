...
use Workdo\Account\Http\Controllers\UpiSettingsController;
...
Route::middleware(['web', 'auth', 'verified', 'PlanModuleCheck:Account'])->group(function () {
    ...
    Route::prefix('account/settings')->name('account.settings.')->group(function () {
        Route::get('/upi',  [UpiSettingsController::class, 'index'])->name('upi');
        Route::post('/upi', [UpiSettingsController::class, 'store'])->name('upi.save');
    });
