...
const getPackageComponents = (activatedPackages: string[]) => {
  try {
    const modules = import.meta.glob([
      '../../../packages/workdo/*/src/Resources/js/settings/components/*.tsx',
      '!../../../packages/workdo/Pos/src/Resources/js/settings/components/*.tsx',
    ]);
    const packageComponents: Record<string, any> = {};

    filterFrontendPackages(activatedPackages).forEach(packageName => {
