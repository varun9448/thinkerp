...
import { isPackageFrontendDisabled } from '@/utils/frontend-packages';
...
function PlanForm({ plan, activeModules, isEdit = false, userSubscriptionInfo }: Props) {
    ...
    const visibleActiveModules = activeModules.filter((module) => !isPackageFrontendDisabled(module.module));
    const visibleSelectedModulesCount = data.modules.filter((moduleName) => !isPackageFrontendDisabled(moduleName)).length;

    const filteredModules = visibleActiveModules.filter(module =>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-3 space-y-4">
                    ...
                    {userSubscriptionInfo && (
                        <SubscriptionInfo
                            userSubscriptionInfo={userSubscriptionInfo}
                            totalModulesCount={visibleActiveModules.length}
                        />
                    )}
                    <Card>
                        ...
                        <CardHeader>
                            <CardTitle className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <Badge>{visibleSelectedModulesCount} {t('selected')}</Badge>
